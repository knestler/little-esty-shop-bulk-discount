...
@invoice_items_1 = InvoiceItem.create!(item_id: @item_1.id, invoice_id: @invoice_1.id, quantity: 22, unit_price: 11, status: "shipped", created_at: Time.parse("22.11.02"))
@invoice_items_2 = InvoiceItem.create!(item_id: @item_2.id, invoice_id: @invoice_2.id, quantity: 2222, unit_price: 11, status: "packaged", created_at: Time.parse("22.11.06"))
@invoice_items_3 = InvoiceItem.create!(item_id: @item_3.id, invoice_id: @invoice_3.id, quantity: 20, unit_price: 11, status: "pending", created_at: Time.parse("22.11.04"))
@invoice_items_4 = InvoiceItem.create!(item_id: @item_1.id, invoice_id: @invoice_4.id, quantity: 12, unit_price: 11, status: "packaged", created_at: Time.parse("22.11.08"))
@invoice_items_5 = InvoiceItem.create!(item_id: @item_2.id, invoice_id: @invoice_5.id, quantity: 7, unit_price: 11, status: "pending", created_at: Time.parse("22.11.03"))
